        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', color: 'var(--text)' }}>
          <div>
            ...
            <p style={{ marginTop: '4px', color: 'var(--muted)', lineHeight: '1.5' }}>
              Перейдите во вкладку <strong>Занятия</strong> и нажмите кнопку «Добавить занятие» в правом верхнем углу. Заполните название, дату, время и вместимость. После сохранения занятие мгновенно появится и в CRM, и на публичном сайте для клиентов. Если нужно удалить занятие — нажмите кнопку «Удалить» в таблице в самом низу страницы.
            </p>
          </div>
          <div>
